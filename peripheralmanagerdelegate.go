...
type PeripheralManagerDelegate interface {
	...
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393317-peripheralmanager
	PeripheralManagerWillRestoreState(pmgr PeripheralManager, opts PeripheralManagerRestoreOpts)

	// DidAddService
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393279-peripheralmanager
	DidAddService(pmgr PeripheralManager, svc Service, err error)

	// DidStartAdvertising
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393321-peripheralmanagerdidstartadverti
	DidStartAdvertising(pmgr PeripheralManager, err error)

	// CentralDidSubscribe
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393261-peripheralmanager
	CentralDidSubscribe(pmgr PeripheralManager, cent Central, chr Characteristic)

	// CentralDidUnsubscribe
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393289-peripheralmanager
	CentralDidUnsubscribe(pmgr PeripheralManager, cent Central, chr Characteristic)

	// IsReadyToUpdateSubscribers
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393248-peripheralmanagerisreadytoupdate
	IsReadyToUpdateSubscribers(pmgr PeripheralManager)

	// DidReceiveReadRequest
	//
	// https://developer.apple.com/documentation/corebluetooth/cbperipheralmanagerdelegate/1393257-peripheralmanager
