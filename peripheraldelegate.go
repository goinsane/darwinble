...
type PeripheralDelegate interface {
	...
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1519124-peripheral
	DidDiscoverIncludedServices(prph Peripheral, svc Service, err error)

	// DidDiscoverCharacteristics
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518821-peripheral
	DidDiscoverCharacteristics(prph Peripheral, svc Service, err error)

	// DidDiscoverDescriptors
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518785-peripheral
	...
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518929-peripheral
	DidUpdateValueForDescriptor(prph Peripheral, dsc Descriptor, err error)

	// DidWriteValueForCharacteristic
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518823-peripheral
	DidWriteValueForCharacteristic(prph Peripheral, chr Characteristic, err error)

	// DidWriteValueForDescriptor
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1519062-peripheral
	DidWriteValueForDescriptor(prph Peripheral, dsc Descriptor, err error)

	// IsReadyToSendWriteWithoutResponse
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/2874034-peripheralisreadytosendwritewith
	IsReadyToSendWriteWithoutResponse(prph Peripheral)

	// DidUpdateNotificationState
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518768-peripheral
	DidUpdateNotificationState(prph Peripheral, chr Characteristic, err error)

	// DidReadRSSI
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1620304-peripheral
	DidReadRSSI(prph Peripheral, rssi int, err error)

	// DidUpdateName
	// https://developer.apple.com/documentation/corebluetooth/cbperipheraldelegate/1518801-peripheraldidupdatename
